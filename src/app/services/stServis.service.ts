...
export class StServisService {
  ...
  DosyaByKategori(kategori: string) {
    //return this.db.list(this.basePath).query.orderByChild("kategori").equalTo(kategori);
    return this.db.list("/Dosyalar", q => q.orderByChild("kategori").equalTo(kategori));
  }
